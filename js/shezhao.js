        ...
        PageCtrFn.prototype.getDateFn = function(num){
            $.get("http://192.168.43.210/qqq/byteDance/php/xiaoyuanzhaopin.php",function(data){
                console.log(data);
                ...
                for (var i = 0; i < jsonstr.data.length; i++) {
                    domStr +="<tr><td style='padding-left:35px'>"+jsonstr.data[i].职位名称+"</td><td>"+jsonstr.data[i].职位类别+"</td><td>"+jsonstr.data[i].职位类型+"</td><td>"+jsonstr.data[i].工作地点+"</td><td>"+jsonstr.data[i].发布时间+"</td></tr>"
;
                }
                domStr += "</table>";
